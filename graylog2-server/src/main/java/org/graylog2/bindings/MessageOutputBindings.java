...
import org.graylog2.outputs.MeasurementOutput;
...
public class MessageOutputBindings extends AbstractModule {
    ...
    protected void configure() {
        bind(MessageOutput.class).annotatedWith(DefaultMessageOutput.class).to(MeasurementOutput.class).in(Scopes.SINGLETON);
